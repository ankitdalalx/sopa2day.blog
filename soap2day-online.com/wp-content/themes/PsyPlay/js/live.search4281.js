					...
					$.each( data, function( key, val ) {
						...
						kat = '';
					  	...
					  	if( val['extra']['imdb'] !== false )
					   	...
					   	items.push("<li><a style=\"background-image: url(" + val['img'] + ")\" class=\"thumb\" href=\"" + val['url'] + "\"></a><div class=\"ss-info\"><a href=\"" + val['url'] + "\" class=\"ss-title\">" + val['title'] + date + "</a><p>" + imdb + "</p><p>"  + val['kat'] +  "</p><div class=\"clearfix\"></div></li>");
					});
